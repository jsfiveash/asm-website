...
! function() {
    ...
    var a = {
                    ...
                    a = b.extend({
                        ...
                        function c() {
                            var e, i = !0,
                                j = 0;
                            g.each(function() {
                                b(this)[0].complete && b(this)[0].naturalWidth > 0 ? j++ : i = !1
                            }), e = parseInt(100 * j / h), a.progress({
                                percent: e
        ...
        p = function(a) {
            ...
            return e.prototype = {
                next: function() {
                    ...
                    a.length ? this.show(a) : this.show(this.$element.find(".pt-part").eq("backward" === this.direction ? -1 : 0).find(".pt-page").eq(0))
                },
                show: function(a, c) {
        ...
        s = function() {
            ...
            return b.prototype = {
                generateImgTag: function(b) {
                    var c = a('<img src="' + b.src + '" />');
                    return b.alt && c.attr("alt", b.alt), b.bgColor && c.attr("data-jgallery-bg-color", b.bgColor), b.textColor && c.attr("data-jgallery-text-color", b.textColor), c
                },
                preload: function() {
                    var a = this.$element;
                    a.jLoader({
                ...
                render: function() {
                    var b = this.$element = a('<a href="' + this.url + '">' + this.generateImgTag({
                        src: this.thumbUrl,
                        bgColor: this.bgColor,
                        textColor: this.textColor,
                        alt: this.title
                    }).outerHtml() + "</a>");
                    return this.target && b.attr("target", this.target), this.link && b.attr("link", this.link), b.attr("data-jgallery-photo-id", this.photoId).attr("data-jgallery-number", this.number), b
                }
            }, b
        }(),
        t = function(a) {
            ...
            return e.prototype = {
                ...
                initSwipeEvents: function() {
                    if (b.fn.swipe) {
                        var a, c, d = this.$container,
                            e = this,
                            f = function(a) {
                                e.isVertical() || e.isFullScreen() ? d.css({
                ...
                reload: function() {
                    this.$a = this.getElement().find("a"), this.$img = this.getElement().find("img"), this.$albums = this.getElement().find(".album").length ? this.getElement().find(".album") : this.getElement().find(".jgallery-container-inner"), this.zoom.showPhoto(this.$albums.find("a").eq(0))
                },
                bindEvents: function() {
                    var a = this;
        ...
        u = function(a, b) {
            ...
            return d.prototype = {
                start: function() {
                    this.$thumbnailsContainerInner.html(""), this.jGallery.options.items ? this.processOptions() : this.processHtml(), this.refreshThumbsSize()
                },
                processOptions: function() {
                    function a(a, b) {
                        var d = new s(c.extend({
                            photoId: this.intI++,
                            number: this.intNo++
                        }, a));
                        b.append(d.render()), d.preload()
                    }
                    this.booIsAlbums ? this.jGallery.options.items.forEach(function(b) {
                        var c = this.$thumbnailsContainerInner.append('<div class="album" data-jgallery-album-title="' + b.title + '"></div>').children(":last-child");
                        this.intNo = 1, b.images.forEach(function(b) {
                            a.call(this, b, c)
                        }, this)
                    }, this) : (this.intNo = 1, this.jGallery.options.items.forEach(function(b) {
                        a.call(this, b, this.$thumbnailsContainerInner)
                    }, this))
                },
                processHtml: function() {
                    var a = this,
                        b = this.jGallery.isSlider() ? ".album:has(img)" : ".album:has(a:has(img))";
                    c("body").append('<div id="jGalleryTmp" style="position: absolute; top: 0; left: 0; width: 0; height: 0; z-index: -1; overflow: hidden;">' + this.$element.html() + "</div>"), this.$tmp = c("#jGalleryTmp"), this.booIsAlbums ? this.$tmp.find(b).each(function() {
                        a.insertAlbum(c(this))
                    }) : this.insertImages(this.$tmp, this.$thumbnailsContainerInner), this.$tmp.remove()
                },
                ...
                insertImage: function(a, b) {
                    var c = a.parent(),
                        d = a.is("img") ? a : a.find("img").eq(0),
                        e = new s({
                            photoId: this.intI++,
                            number: this.intNo++,
                            url: a.is("img") && this.isSlider ? a.attr("src") : a.attr("href"),
                            link: a.is("img") && this.isSlider && c.is("a") ? c.attr("href") : void 0,
                            target: a.is("img") && this.isSlider && c.is("a") && c.is("[target]") ? c.attr("target") : void 0,
                            thumbUrl: d.attr("src"),
                            title: d.attr("alt"),
                            bgColor: d.attr("data-jgallery-bg-color"),
                            textColor: d.attr("data-jgallery-text-color")
                        });
                    b.append(e.render()), e.preload()
                },
            ...
            return k.prototype = {
                ...
                enableDrag: function() {
                    var a, b, c, d, e, f, g = this,
                        h = function() {
                            return parseInt(a) - parseInt(f.css("margin-left"))
                        },
                        i = function(h) {
                            c = h.pageX, d = h.pageY, e = h, f = g.$element.find("img.active"), a = f.css("margin-left"), b = f.css("margin-top"), g.$element.on({
                                mousemove: k,
                                touchmove: k,
                                mouseleave: j,
                                touchend: j
                            }), "fill" === g.jGallery.options.zoomSize && g.$dragNav.removeClass("hide").addClass("show"), l(0, 0)
                        },
                        j = function() {
                            var a = h(),
                                b = c - e.pageX;
                            g.$element.off("mousemove touchmove mouseleave touchend"), "fill" === g.jGallery.options.zoomSize && g.$dragNav.removeClass("show").addClass("hide"), g.jGallery.options.swipeEvents && 0 === a && (b > 0 ? g.showNextPhoto() : 0 > b && g.showPrevPhoto())
                        },
                        k = function(a) {
                            e = "touchmove" === a.type ? a.originalEvent.touches[0] : a;
                            var b = {
                                    x: e.pageX - c,
                                    y: e.pageY - d
                                },
                                f = {};
                            g.jGallery.options.draggableZoom && (f = l(b.x, b.y)), Math.abs(b.y) > Math.abs(b.x) && f.y ? a.preventDefault() : Math.abs(b.x) >= Math.abs(b.y) && f.x && a.preventDefault()
                        },
                        l = function(c, d) {
                            var e = parseFloat(parseFloat(a) + c),
                                f = parseFloat(parseFloat(b) + d),
                                h = g.$element.find("img.active"),
                                i = h.eq(0),
                                j = i.position(),
                                k = j.left,
                                l = j.top,
                                ...
                                q = p.position(),
                                r = {
                                    x: 0 > k + e && n.left + m.width() + e > o.outerWidth(),
                                    y: 0 > l + f && n.top + m.height() + f > o.outerHeight()
                                };
                            return r.x && (h.css({
                                "margin-left": e
                            }), p.css({
                                left: -(k + e) / h.width() * 100 + "%"
                            })), r.y && (h.css({
                                "margin-top": f
                            }), p.css({
                                top: -(l + f) / h.height() * 100 + "%"
                            })), q && g.$dragNavCropImg.css({
                                "margin-left": -q.left,
                                "margin-top": -q.top
                            }), r
                        };
                    this.refreshDragNavCropSize(), this.jGallery.options.draggableZoom && (this.refreshCursor(), window.addEventListener("resize", this.refreshCursor.bind(this))), this.$element.on({
                        mousedown: function(a) {
                            i(a), g.slideshowPause()
                        },
                        touchstart: function(a) {
                            i(a.originalEvent.touches[0]), g.slideshowPause()
                        },
                        mouseup: function() {
                            j()
                        },
                ...
                canDrag: function() {
                    var a = this.$element.get(0),
                        b = a.querySelector("img.active");
                    return b && this.jGallery.options.draggableZoom && (b.clientWidth > a.clientWidth || b.clientHeight > a.clientHeight)
                },
                ...
                changeSize: function() {
                    if ("fit" === this.jGallery.options.zoomSize) this.jGallery.options.zoomSize = "fill";
                        ...
                        this.$element.outerWidth().toString() === a.attr("data-width") ? this.jGallery.options.zoomSize = "fit" : this.jGallery.options.zoomSize = "original"
                ...
                setImgSizeForFit: function(a) {
                    ...
                    }), a.width() / a.height() / this.jGallery.getCanvasRatioWidthToHeight() < 1 ? a.css({
                        width: "auto",
                ...
                isLoaded: function(a) {
                    var b = this.$element.find("img").filter('[src="' + a.attr("href") + '"]').get(0);
                    return b ? this.imgIsLoaded(b) : void 0
                },
                imgIsLoaded: function(a) {
                    return a.complete && a.naturalWidth > 0
                },
                refreshNav: function() {
                ...
                showPhoto: function(a, b) {
                    var c, e, g, h, i = this,
                        j = a.children("img"),
                        k = a.next();
                    k.length > 0 && (i.isAddedToLoad(k) || this.appendPhoto(k));
                    var l = a.prev();
                    if (l.length > 0 && (i.isAddedToLoad(l) || this.appendPhoto(l)), this.jGallery.initialized() || this.showPhotoInit(), !this.booLoadingInProgress) {
                        ...
                        }), i.jGallery.options.beforeLoadPhoto(a, j), i.loadPhoto(i.$element, a, b)) : i.showPhotoSuccess(a, j, b)
                    }
                },
                ...
                appendAllPhotos: function() {
                    ...
                    this.jGallery.options.preloadAll && (this.thumbnails.$a.each(function() {
                        var b = i(this);
                        a.isAddedToLoad(b) || a.$element.find(".pt-part").append('<div class="jgallery-container pt-page"><div class="pt-item"><img src="' + b.attr("href") + '" /></div></div>')
                    ...
                    h.jLoader({
                        ...
                        success: function() {
                            a.find("img").each(function() {
                                var a = i(this);
                                d.imgIsLoaded(a.get(0)) && a.addClass("loaded")
                            }), d.$container.overlay({
                                hide: !0,
                                hideLoader: !0
                            }), d.showPhotoSuccess(b, e, c)
                        },
                        progress: function(a) {
                ...
                showPhotoSuccess: function(a, b, d) {
                    var e, f = this.$element.find("img.active");
                    d = i.extend({}, {
                        historyPushState: !0
                    }, d), f.is(":not([data-width])") && (e = new Image, e.src = f.attr("src"), f.attr("data-width", e.width), f.attr("data-height", e.height)), this.jGallery.options.title && b.attr("alt") ? (this.$title.html(b.attr("alt")).removeClass("before").removeClass("after"), this.jGallery.$element.addClass("has-title")) : this.jGallery.$element.removeClass("has-title"), this.setJGalleryColoursForActiveThumb(), this.$element.find(".pt-page.init").css({
                        visibility: "visible"
                    }), this.$element.find("img.prev-img").removeClass("prev-img"), this.advancedAnimation.show(f.eq(0).parent().parent(), {
        ...
        w = function(a, b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
            var p = jQuery,
                q = p("html"),
                r = p("head"),
                s = p("body"),
            ...
            var u = function(a, b, c) {
                var f = this;
                b && !a.is("[data-jgallery-id]") && (this.$this = a, this.intId = b, this.$this.attr("data-jgallery-id", this.intId), this.overrideOptions(c), this.booIsAlbums = this.options.items && this.options.items[0].images || a.find(".album:has(a:has(img))").length > 1, this.options.disabledOnIE8AndOlder && d() || this.init({
                    success: function() {
                            ...
                            keydown: function(a) {
                                if (f.$element.is(":visible")) {
                                    if (27 === a.which) {
                                        ...
                                        f.isFullScreenMode() && !f.canClose() && f.zoom.changeMode(), f.hide()
                                    }
            ...
            return u.prototype = {
                ...
                overrideOptions: function(a) {
                    ...
                    this.options = p.extend({}, f, this.options), b && "full-screen" === a.mode ? this.options = p.extend({}, this.options, g, a, i) : b && "slider" === a.mode ? this.options = p.extend({}, this.options, h, a, j) : this.options = p.extend({}, this.options, a)
                },
                ...
                show: function() {
                    this.options.items || this.$this.hide(), t.on("resize", {
                        jGallery: this
                ...
                init: function(a) {
                    ...
                    a = p.extend({
                        ...
                        success: function() {
                            ...
                            }), b.thumbnails.bindEvents(), a.success(), b.options.hideThumbnailsOnInit && b.zoom.$container.find(".minimalize-thumbnails").addClass("inactive")
                        }
